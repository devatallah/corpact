...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // Spec (H §20): daily backup of database + storage. Code lives
                // in git — only user data is backed up: uploads on the private
                // disk and any remaining public-disk legacy files.
                'include' => [
                    storage_path('app'),
                ],
        ...
        'destination' => [
             ...
             */
            // Production must ship backups off-server (BACKUP_DISK=s3 — a
            // separate bucket from user uploads is strongly recommended).
            'disks' => [
         ...
         * Spec (H §20): «النسخة غير المختبَرة ليست نسخة».
         */
        'verify_backup' => true,
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_MAIL', 'ops@teamat.sa'),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             * Spec (H §20): daily backups with 30-day retention.
             */
