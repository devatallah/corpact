...
class EventCreationService
{
     ...
     *
     * @param  array{court_pricing_id: int, court_ids: array<int>, capacity: int, company_subsidy: float, community_balance: float}  $params
     * @return array{total_cost: float, company_subsidy: float, community_contribution: float, player_payment: float, cost_per_person: float}
     */
    public function calculateCosts(array $params): array
    {
        ...
        $communityContribution = min($totalCost, $communityBalance);
        $companySubsidy = $communityContribution;
        $remainingCost = $totalCost - $communityContribution;
