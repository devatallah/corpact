...
class ScheduleService
{
     ...
     */
    public function getScheduleGrid(Partner $partner, string $date): array
    {
     ...
     */
    public function getSchedule(int $partnerId, string $date): Collection
    {
        $venueIds = Venue::where('partner_id', $partnerId)->pluck('id');
