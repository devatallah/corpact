...
<body>
  ...
  <div class="section-cream">
    <div class="page-container">
      ...
      <p class="section-text">بدأت تيمات من فكرة بسيطة: ماذا لو استطاعت كل شركة أن توفّر لموظفيها تجربة رياضية حقيقية دون عناء التنسيق اليدوي؟ من هنا، بنينا منصة تربط الشركات بأفضل المرافق الرياضية في المملكة — من ملاعب البادل والتنس إلى المرافق الرياضية المتكاملة. تيمات تُحوّل زملاء العمل إلى فريق رياضي حقيقي عبر تقنية تُسهّل تنظيم الفعاليات، تُدير الميزانيات، وتبني مجتمعات رياضية نابضة بالحياة داخل كل شركة.</p>
