...
<div class="login-container">
    <div class="logo-section">
        ...
        <div class="logo-tag">partner</div>
        <div class="logo-desc">بوابة الشركاء</div>
    </div>

    <div class="card">
        <div class="card-title">تسجيل الدخول</div>
        <div class="card-sub">أدخل بياناتك للوصول إلى لوحة الشريك</div>
        ...
        <form method="POST" action="{{ route('partner.login') }}">
            ...
            <div class="field">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="partner@teamat.com" required autofocus dir="ltr">
            </div>
            ...
            <div class="field-row">
                ...
                <a href="{{ route('partner.password.request') }}" style="font-size:12px;color:#009E82;text-decoration:none;">نسيت كلمة المرور؟</a>
            </div>
        ...
        <div class="login-link" style="text-align:center;margin-top:20px;">
            <a href="{{ route('partner.register') }}" style="font-size:13px;color:#009E82;text-decoration:none;">ليس لديك حساب؟ سجل الآن</a>
        </div>

        <div class="demo-section">
            <div class="demo-title">حسابات تجريبية</div>
            <div class="demo-grid">
                <button type="button" class="demo-btn" onclick="fillDemo('partner1@teamat.com')">
                    <div class="demo-role">شريك 1</div>
                    <div class="demo-email">partner1@teamat.com</div>
                </button>
                <button type="button" class="demo-btn" onclick="fillDemo('partner2@teamat.com')">
                    <div class="demo-role">شريك 2</div>
                    <div class="demo-email">partner2@teamat.com</div>
                </button>
            </div>
        </div>
    </div>
