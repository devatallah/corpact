...
<div class="login-container">
    ...
    <div class="card">
        <div class="card-title">كلمة مرور جديدة</div>
        ...
        <form method="POST" action="{{ route('partner.password.update') }}">
            ...
            <div class="field">
                ...
                <input type="email" id="email" name="email" value="{{ $email }}" required dir="ltr">
            </div>
            <div class="field">
                <label for="password">كلمة المرور الجديدة</label>
                <input type="password" id="password" name="password" placeholder="8 أحرف على الأقل" required dir="ltr">
            </div>
            <div class="field">
                <label for="password_confirmation">تأكيد كلمة المرور</label>
                <input type="password" id="password_confirmation" name="password_confirmation" placeholder="أعد كتابة كلمة المرور" required dir="ltr">
            </div>
