...
* @route '/employee/email/verify/{id}/{hash}'
*/
...
verify.definition = {
    methods: ["get","head"],
    url: '/employee/email/verify/{id}/{hash}',
...
* @route '/employee/email/verification-notification'
*/
...
send.definition = {
    methods: ["post"],
    url: '/employee/email/verification-notification',
