...
* @route '/company/email/verify/{id}/{hash}'
*/
...
verify.definition = {
    methods: ["get","head"],
    url: '/company/email/verify/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/company/email/verification-notification'
*/
...
send.definition = {
    methods: ["post"],
    url: '/company/email/verification-notification',
