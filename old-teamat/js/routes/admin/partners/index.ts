...
/**
* @see \App\Http\Controllers\Admin\PartnerController::resetPassword
* @see app/Http/Controllers/Admin/PartnerController.php:146
* @route '/admin/partners/{partner}/reset-password'
*/
export const resetPassword = (args: { partner: number | { id: number } } | [partner: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/partners/{partner}/reset-password'
*/
resetPassword.url = (args: { partner: number | { id: number } } | [partner: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { partner: args }
    }
...
* @route '/admin/partners/{partner}/reset-password'
*/
resetPassword.post = (args: { partner: number | { id: number } } | [partner: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: resetPassword.url(args, options),
    method: 'post',
})
...
* @route '/admin/partners/{partner}/reset-password'
*/
const resetPasswordForm = (args: { partner: number | { id: number } } | [partner: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/partners/{partner}/reset-password'
*/
resetPasswordForm.post = (args: { partner: number | { id: number } } | [partner: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: resetPassword.url(args, options),
    method: 'post',
})
