...
* @route '/partner/email/verify/{id}/{hash}'
*/
...
verify.definition = {
    methods: ["get","head"],
    url: '/partner/email/verify/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/partner/email/verification-notification'
*/
...
send.definition = {
    methods: ["post"],
    url: '/partner/email/verification-notification',
