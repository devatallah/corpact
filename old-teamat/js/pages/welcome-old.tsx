...
.wwh-tag.emp { background: rgba(0,158,130,.12); color: #E8F5E9; }
.wwh-tag.biz { background: rgba(232,89,58,.12); color: #C87D00; }
.wwh-tag.co { background: rgba(59,91,219,.12); color: #F6F8F5; }
...
export default function Welcome() {
    ...
    const [activePortal, setActivePortal] = useState<'employee' | 'hr' | 'business'>('employee');
    ...
    const portalTabs: { key: 'employee' | 'hr' | 'business'; num: string; label: string }[] = [
        { key: 'employee', num: '01', label: 'الموظف' },
        { key: 'hr', num: '02', label: 'الشركة' },
        { key: 'business', num: '03', label: 'مزود الخدمة' },
    ];
                ...
                <div className="wrap hero-grid">
                    <div>
                        ...
                        <p className="hero-sub">
                            تيمات هي المنصّة المؤسسية الأولى التي تربط شركتك بأفضل مزودي الخدمة الرياضية في المملكة. حجوزات جماعية، فعاليات للموظفين، ومجتمع رياضي حقيقي يعيش داخل بيئة العمل — بلوحة تحكّم واحدة لإدارة الموارد البشرية.
                        </p>
                    ...
                    <div className="hero-visual">
                        <div className="hero-orbit">
                            ...
                            <div className="hero-portal-label" style={{ bottom: '10%', left: '-5%' }}>
                                <span className="hero-pl-dot" style={{ background: '#0A0A0A' }}></span>
                                الشركة
                            </div>
                        </div>
                    </div>
                ...
                <div className="wrap">
                    ...
                    <div className="benefits-grid reveal-stagger">
                        <div className="benefit big">
                            ...
                            <p className="benefit-p">انطلق بدون فريق بناء داخلي. تيمات تأتي جاهزة بمزودي الخدمة، الموظفين، الأنظمة، والتقارير — لتقدّم أثراً ملموساً من اليوم الأول.</p>
            ...
            <section className="portals section-pad" id="portals">
                <div className="wrap">
                    <div className="section-head reveal">
                        ...
                        <p className="section-sub">من الموظف الذي يبحث عن مباراة بعد العمل، إلى مدير الموارد البشرية الذي يقيس الأثر، إلى مزود الخدمة الذي يدير ملاعبه — كلٌ بأدواته.</p>
                    </div>
                    ...
                    {/* BUSINESS PANEL */}
                    <div className={`portal-panel${activePortal === 'business' ? ' active' : ''}`}>
                        <div className="section-head reveal">
                            <div className="eyebrow">رحلة مزود الخدمة الشريك</div>
                            <h2 className="section-title">من التسجيل <span className="serif-en">to monthly settlement</span>.</h2>
                            <p className="section-sub">شاهد كيف يدير مزودو الخدمة ملاعبهم وحجوزاتهم وإيراداتهم عبر تيمات — من لحظة الانضمام إلى التسوية الشهرية.</p>
                        </div>
                        <JourneySlider total={6}>
                            <div className="journey-step" dangerouslySetInnerHTML={{ __html: `<div class="journey-content"><div class="journey-num"><span class="journey-num-n">01</span><span class="journey-num-l">/ APPLY · 24h VERIFICATION</span></div><h3 class="journey-h">انضم لشبكة الشركات في 48 ساعة.</h3><p class="journey-p">يقدّم مزود الخدمة طلب الانضمام عبر استمارة بسيطة: الموقع، الرياضات، عدد الملاعب، وصور. فريق تيمات يتحقّق ويفعّل مزود الخدمة خلال يوم عمل واحد — لا عقود طويلة، لا رسوم انضمام.</p><ul class="journey-feat"><li>تسجيل مجاني، بدون عقود طويلة الأمد</li><li>تحقّق سريع خلال 24 ساعة</li><li>دعم متخصص بالعربية من فريق الشراكات</li></ul></div><div class="journey-mock"><div class="journey-visual"><span class="journey-visual-num">01</span><span class="journey-visual-icon">📋</span></div></div>` }} />
                            <div className="journey-step alt" dangerouslySetInnerHTML={{ __html: `<div class="journey-content"><div class="journey-num"><span class="journey-num-n">02</span><span class="journey-num-l">/ COURT SETUP · YOUR PRICES</span></div><h3 class="journey-h">أسعار مرنة لكل ملعب ولكل مدة.</h3><p class="journey-p">يضع مزود الخدمة أسعاره الخاصة لكل ملعب، حسب المدة (60، 90، 120 دقيقة). لا قيود من تيمات على التسعير — مزود الخدمة يحتفظ بسلطته الكاملة على أسعاره.</p><ul class="journey-feat"><li>تسعير ديناميكي حسب اليوم والوقت</li><li>أسعار مختلفة للشركات والأفراد</li><li>عروض موسمية قابلة للجدولة</li></ul></div><div class="journey-mock"><div class="journey-visual"><span class="journey-visual-num">02</span><span class="journey-visual-icon">🏷️</span></div></div>` }} />
                            <div className="journey-step" dangerouslySetInnerHTML={{ __html: `<div class="journey-content"><div class="journey-num"><span class="journey-num-n">03</span><span class="journey-num-l">/ INCOMING REQUESTS · CORPORATE</span></div><h3 class="journey-h">حجوزات الشركات تصل تلقائياً.</h3><p class="journey-p">بمجرّد التفعيل، يبدأ مزود الخدمة باستقبال طلبات حجز من شركات تيمات. كل طلب يأتي مع تفاصيل الفريق، الوقت، والمبلغ. قبول أو رفض بنقرة — أو تفعيل القبول التلقائي للشركات الموثوقة.</p><ul class="journey-feat"><li>طلبات مفصّلة مع عدد اللاعبين والوقت</li><li>قبول تلقائي للشركات الموثوقة</li><li>إشعارات فورية على الجوال</li></ul></div><div class="journey-mock"><div class="journey-visual"><span class="journey-visual-num">03</span><span class="journey-visual-icon">📬</span></div></div>` }} />
