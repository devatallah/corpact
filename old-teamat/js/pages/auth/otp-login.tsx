                    ...
                    <div style={{ background: '#fff', border: '1px solid rgba(10,10,10,0.1)', borderRadius: 20, padding: '36px 32px', width: '100%', maxWidth: 460, boxShadow: '0 4px 24px rgba(26,26,24,.06)' }}>
                        ...
                        {step === 'context' ? (
                            ...
                            <form onSubmit={verifyCode}>
                                <div style={{ background: 'rgba(200,255,0,.12)', border: '1px solid rgba(200,255,0,.4)', borderRadius: 14, padding: 12, fontSize: 13, color: '#2E7D32', fontWeight: 600, marginBottom: 20, textAlign: 'center' }}>
