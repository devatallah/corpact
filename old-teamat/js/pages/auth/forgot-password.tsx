            ...
            <div dir="rtl" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 'calc(100vh - 64px)', padding: '40px 16px' }}>
                    <div style={{
                        ...
                        <div style={{ fontSize: 18, fontWeight: 800, textAlign: 'center', color: '#0A0A0A', marginBottom: 4, fontFamily: "'Almarai', sans-serif" }}>نسيت كلمة المرور</div>
                        <div style={{ fontSize: 13, color: 'rgba(10,10,10,.55)', textAlign: 'center', marginBottom: 24 }}>
                            أدخل بريدك الإلكتروني وسنرسل لك رابط إعادة التعيين
                        </div>

                        {/* Status */}
                        {(flash as Record<string, unknown>)?.status ? (
                            <div style={{ background: '#0A0A0A08', border: '1px solid #C8FF0040', borderRadius: 12, padding: 12, fontSize: 13, color: '#0A0A0A', fontWeight: 600, marginBottom: 14 }}>
                        ...
                        {/* Error */}
                        {errors.email && (
                            <div style={{ background: '#D9381E10', border: '1px solid #D9381E30', borderRadius: 12, padding: '10px 14px', fontSize: 13, color: '#D9381E', fontWeight: 600, marginBottom: 14 }}>
                                {errors.email}
                            </div>
                        )}
                        ...
                        {/* Back to login */}
                        <div style={{ textAlign: 'center', fontSize: 13, color: 'rgba(10,10,10,.55)' }}>
                            <a href={`/${guardPrefix(guard)}/login`} style={{ fontWeight: 600, textDecoration: 'none', color: '#C87D00' }}>
