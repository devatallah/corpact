...
export default function Login({ guard, guardLabel, status }: Props) {
                    ...
                    <div style={{
                        ...
                        <form onSubmit={submit}>
                            ...
                            <div style={{ textAlign: 'left', marginBottom: 20 }}>
                                <a href={`/${guardPrefix(guard)}/forgot-password`} style={{ fontSize: 12, color: '#C87D00', textDecoration: 'none' }}>نسيت كلمة المرور؟</a>
                            </div>
                        ...
                        <div style={{ textAlign: 'center', fontSize: 13, color: 'rgba(10,10,10,0.6)' }}>
                            ...
                            <a href={cfg.registerHtml.href} style={{ fontWeight: 600, textDecoration: 'none', color: '#C87D00' }}>{cfg.registerHtml.label}</a>
                        </div>
