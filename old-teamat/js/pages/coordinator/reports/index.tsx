        ...
        <AdminLayout>
            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 16, flexWrap: 'wrap' }}>
                <input
                    ...
                    style={{ flex: 1, minWidth: 220, padding: '10px 14px', background: '#FFFFFF', border: '0.5px solid rgba(10,10,10,.1)', borderRadius: 10, fontSize: 13, color: '#0A0A0A', outline: 'none', direction: 'rtl', fontFamily: 'inherit' }}
                />
                    ...
                    <tbody>
                        ...
                        {reports.data.map((report) => (
                            <tr key={report.id}>
                                ...
                                <td style={tdStyle}>
                                    <Link href={`/coordinator/reports/${report.id}`} style={{ color: '#D9381E', fontSize: 12 }}>
                                        فتح
                                    </Link>
                                </td>
                            </tr>
