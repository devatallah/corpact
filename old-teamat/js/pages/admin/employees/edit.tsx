    ...
    return (
        <AdminLayout>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                <Link href="/admin/employees" style={{ color: 'rgba(10,10,10,.55)', textDecoration: 'none', fontSize: '14px' }}>
                    ← الموظفون
                </Link>
                <span style={{ color: '#0A0A0A' }}>/</span>
                <span style={{ color: '#0A0A0A', fontWeight: 700 }}>تعديل: {employee.name}</span>
            </div>
