                ...
                <table className="portal-table">
                    ...
                    <tbody>
                        ...
                        {admins.data.map((admin) => (
                            <tr key={admin.id}>
                                <td>
                                    <div style={{ fontWeight: 700, color: '#0A0A0A' }}>{admin.name ?? '-'}</div>
                                    <div style={{ fontSize: '10px', color: 'rgba(10,10,10,.55)' }}>{admin.email ?? '-'}</div>
                                </td>
                                <td>
                                    <span style={{
                                        padding: '3px 10px',
                                        ...
                                        color: admin.role === 'platform_admin' ? '#D9381E' : admin.role === 'finance_admin' ? '#0A0A0A' : '#2E7D32',
                                    }}>
                                        {roleLabels[admin.role] ?? admin.role}
                                    </span>
                                </td>
                                <td style={{ color: '#0A0A0A', direction: 'ltr', textAlign: 'right' }}>{admin.phone ?? '-'}</td>
                                <td style={{ fontSize: '12px', color: 'rgba(10,10,10,.55)' }}>{fmtDateTime(admin.created_at)}</td>
                                <td>
