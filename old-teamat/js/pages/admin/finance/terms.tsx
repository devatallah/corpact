...
export default function FinanceTerms({ providers, companies }: Props) {
    ...
    const input = { padding: '9px 14px', borderRadius: 10, border: '0.5px solid rgba(10,10,10,.1)', fontSize: 13 };
    ...
    return (
        <AdminLayout>
            ...
            <PageHeader
                title={<>الشروط المالية المستقبلية</>}
                subtitle={<>
            ...
            >
                ...
                {rateForm.errors.effective_from && (
                    <div style={{ color: '#D9381E', fontSize: 12, marginBottom: 10 }}>
                        {rateForm.errors.effective_from}
                    </div>
                )}
