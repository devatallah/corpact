...
export default function InvoiceShow({ company, invoice, items }: Props) {
    return (
        <CompanyLayout>
            ...
            <PageHeader
                title={<>{invoice.serial ?? `#${invoice.id}`}</>}
                subtitle={<>
            ...
            <div className="card" style={{ marginTop: 16 }}>
                ...
                <p style={{ fontSize: 12, color: 'rgba(10,10,10,.55)', lineHeight: 1.9, marginTop: 14 }}>
            ...
            <div className="card" style={{ marginTop: 16 }}>
                ...
                <div style={{ marginTop: 14, fontSize: 12, color: invoice.is_overdue ? '#D9381E' : 'rgba(10,10,10,.55)', lineHeight: 1.9 }}>
...
function Fact({ label, value }: { label: string; value: string }) {
    return (
        <div>
            ...
            <div style={{ fontSize: 15, fontWeight: 700, color: '#0A0A0A' }} dir="auto">{value}</div>
        </div>
    );
}
