    ...
    return (
        <CompanyLayout>
            ...
            <div style={{ marginBottom: 24 }}>
                <PageHeader title={<>إعدادات الشركة</>} subtitle={<>تُورَّث هذه الإعدادات للفعاليات الجديدة وتُضبط قبل دعوة الموظفين</>} />
            </div>

            <form onSubmit={handleSubmit}>
                <div style={{ background: '#fff', border: '0.5px solid rgba(10,10,10,.1)', borderRadius: 16, padding: '8px 24px', maxWidth: 760 }}>
                    <div style={rowStyle}>
                        <div>
                            <div style={{ fontSize: 14, fontWeight: 700 }}>صلاحية الموظف بإنشاء فعالية</div>
                            <div style={{ fontSize: 12, color: 'rgba(10,10,10,.55)', maxWidth: 480 }}>
                    ...
                    <div style={rowStyle}>
                        <div>
                            ...
                            <div style={{ fontSize: 12, color: 'rgba(10,10,10,.55)' }}>يُورَّث للفعاليات الجديدة وقابل للتجاوز على مستوى القالب والفعالية.</div>
                        </div>
                        <select
                            value={form.data.default_funding_mode}
                            onChange={(e) => form.setData('default_funding_mode', e.target.value)}
                            style={{ padding: '8px 12px', borderRadius: 10, border: '0.5px solid rgba(10,10,10,.1)', fontSize: 13, fontFamily: 'inherit' }}
                        >
                    ...
                    <div style={rowStyle}>
                        <div>
                            ...
                            <div style={{ fontSize: 12, color: 'rgba(10,10,10,.55)' }}>ما تتحمله محفظة المجتمع من كل فعالية. 100 هللة = ريال.</div>
                        </div>
                        <input
                            type="number"
                            min={0}
                            ...
                            style={{ padding: '8px 12px', borderRadius: 10, border: '0.5px solid rgba(10,10,10,.1)', fontSize: 13, width: 120, fontFamily: 'inherit' }}
                        />
                    </div>
                    ...
                    <div style={rowStyle}>
                        <div>
                            ...
                            <div style={{ fontSize: 12, color: 'rgba(10,10,10,.55)' }}>كم ساعة قبل بدء الفعالية يُغلق التسجيل ويبدأ التحصيل.</div>
                        </div>
                        <input
                            type="number"
                            min={1}
                    ...
                    <div style={{ ...rowStyle, borderBottom: 'none' }}>
                        <div>
                            ...
                            <div style={{ fontSize: 12, color: 'rgba(10,10,10,.55)' }}>هل يستطيع القائد تعديل قائمة الحاضرين بعد اكتمال الفعالية.</div>
                        </div>
                        <input
                            type="checkbox"
                ...
                {Object.keys(form.errors).length > 0 && (
                    <div style={{ background: '#D9381E10', border: '1px solid #D9381E33', borderRadius: 10, padding: '10px 14px', marginTop: 16, maxWidth: 760 }}>
                ...
                <button
                    ...
                    style={{ marginTop: 16, background: '#0A0A0A', color: '#fff', border: 'none', borderRadius: 10, padding: '10px 24px', fontSize: 14, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', opacity: form.processing ? 0.6 : 1 }}
                >
                    حفظ الإعدادات
                </button>
            </form>
