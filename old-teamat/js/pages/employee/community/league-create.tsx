    ...
    return (
        <EmployeeLayout>
            ...
            <div style={{ marginBottom: 28 }}>
                <h1 className="text-lg font-black text-[#0A0A0A]">إنشاء بطولة</h1>
            </div>

            {Object.keys(form.errors).length > 0 && (
                <div className="card" style={{ background: '#FDEDEC', borderColor: 'rgba(217,56,30,.25)' }}>
            ...
            <form onSubmit={handleSubmit}>
                            ...
                            return (
                                <label
                                    ...
                                    style={{
                                        ...
                                        borderColor: selected ? color : 'rgba(10,10,10,.55)',
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: 12, color: 'rgba(10,10,10,.5)', marginTop: 2 }}>{opt.desc}</div>
                                    </div>
                                </label>
                            );
                        })}
                ...
                <div className="card">
                    ...
                    {isKnockout && (
                        <div style={{ fontSize: 12, color: count > 0 && !isPowerOf2 ? '#EF4444' : 'rgba(10,10,10,.5)', marginBottom: 12 }}>
                            {count > 0 && !isPowerOf2
                ...
                {isKnockout && seedOrder.length >= 2 && isPowerOf2 && (
                    <div className="card">
                        ...
                        <div style={{ fontSize: 12, color: 'rgba(10,10,10,.5)', marginBottom: 12 }}>رتّب الأقسام — كل زوج متجاور سيتقابل في الدور الأول</div>
                            ...
                            {seedOrder.map((deptId, index) => {
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            cursor: 'default',
                                            background: isTop ? '#F6F8F5' : '#fff',
                                            borderBottom: index % 2 === 1 ? `2px solid ${color}33` : undefined,
                                        }}
                                    >
                                        <span style={{ fontSize: 13, color: 'rgba(10,10,10,.5)', width: 20 }}>{index + 1}</span>
                        ...
                        <div style={{ marginTop: 12, fontSize: 12, color: 'rgba(10,10,10,.5)' }}>
