...
/**
* @see \App\Http\Controllers\Employee\EventController::acceptSeatOffer
* @see app/Http/Controllers/Employee/EventController.php:406
* @route '/employee/detail/{event}/waitlist-offer/accept'
*/
export const acceptSeatOffer = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: acceptSeatOffer.url(args, options),
    method: 'post',
})

acceptSeatOffer.definition = {
    methods: ["post"],
...
* @route '/employee/detail/{event}/waitlist-offer/accept'
*/
acceptSeatOffer.url = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { event: args }
    }
    ...
    return acceptSeatOffer.definition.url
            .replace('{event}', parsedArgs.event.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/employee/detail/{event}/waitlist-offer/accept'
*/
acceptSeatOffer.post = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: acceptSeatOffer.url(args, options),
    method: 'post',
})
...
* @route '/employee/detail/{event}/waitlist-offer/accept'
*/
const acceptSeatOfferForm = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: acceptSeatOffer.url(args, options),
    method: 'post',
})
...
* @route '/employee/detail/{event}/waitlist-offer/accept'
*/
acceptSeatOfferForm.post = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: acceptSeatOffer.url(args, options),
    method: 'post',
})

acceptSeatOffer.form = acceptSeatOfferForm

/**
* @see \App\Http\Controllers\Employee\EventController::declineSeatOffer
* @see app/Http/Controllers/Employee/EventController.php:424
* @route '/employee/detail/{event}/waitlist-offer/decline'
*/
export const declineSeatOffer = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: declineSeatOffer.url(args, options),
    method: 'post',
})

declineSeatOffer.definition = {
    methods: ["post"],
...
* @route '/employee/detail/{event}/waitlist-offer/decline'
*/
declineSeatOffer.url = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { event: args }
    }
    ...
    return declineSeatOffer.definition.url
            .replace('{event}', parsedArgs.event.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/employee/detail/{event}/waitlist-offer/decline'
*/
declineSeatOffer.post = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: declineSeatOffer.url(args, options),
    method: 'post',
})
...
* @route '/employee/detail/{event}/waitlist-offer/decline'
*/
const declineSeatOfferForm = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: declineSeatOffer.url(args, options),
    method: 'post',
})
...
* @route '/employee/detail/{event}/waitlist-offer/decline'
*/
declineSeatOfferForm.post = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: declineSeatOffer.url(args, options),
    method: 'post',
})

declineSeatOffer.form = declineSeatOfferForm

/**
* @see \App\Http\Controllers\Employee\EventController::approveProposal
* @see app/Http/Controllers/Employee/EventController.php:441
* @route '/employee/detail/{event}/proposal/approve'
*/
export const approveProposal = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: approveProposal.url(args, options),
    method: 'post',
})

approveProposal.definition = {
    methods: ["post"],
...
* @route '/employee/detail/{event}/proposal/approve'
*/
approveProposal.url = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { event: args }
    }
    ...
    return approveProposal.definition.url
            .replace('{event}', parsedArgs.event.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/employee/detail/{event}/proposal/approve'
*/
approveProposal.post = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: approveProposal.url(args, options),
    method: 'post',
})
...
* @route '/employee/detail/{event}/proposal/approve'
*/
const approveProposalForm = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: approveProposal.url(args, options),
    method: 'post',
})
...
* @route '/employee/detail/{event}/proposal/approve'
*/
approveProposalForm.post = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: approveProposal.url(args, options),
    method: 'post',
})

approveProposal.form = approveProposalForm

/**
* @see \App\Http\Controllers\Employee\EventController::rejectProposal
* @see app/Http/Controllers/Employee/EventController.php:480
* @route '/employee/detail/{event}/proposal/reject'
*/
export const rejectProposal = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/employee/detail/{event}/proposal/reject'
*/
rejectProposal.url = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { event: args }
    }
...
* @route '/employee/detail/{event}/proposal/reject'
*/
rejectProposal.post = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: rejectProposal.url(args, options),
    method: 'post',
})
...
* @route '/employee/detail/{event}/proposal/reject'
*/
const rejectProposalForm = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/employee/detail/{event}/proposal/reject'
*/
rejectProposalForm.post = (args: { event: number | { id: number } } | [event: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: rejectProposal.url(args, options),
    method: 'post',
})
...
const EventController = { create, pricings, store, show, join, leave, leaveWaitlist, acceptSeatOffer, declineSeatOffer, approveProposal, rejectProposal, acceptAlternative, rejectAlternative, removeMember, refundPreview, extendRegistration, destroy }
