...
/**
* @see \App\Http\Controllers\Admin\CompanyController::sendResetPassword
* @see app/Http/Controllers/Admin/CompanyController.php:174
* @route '/admin/companies/{company}/reset-password'
*/
export const sendResetPassword = (args: { company: number | { id: number } } | [company: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/companies/{company}/reset-password'
*/
sendResetPassword.url = (args: { company: number | { id: number } } | [company: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { company: args }
    }
...
* @route '/admin/companies/{company}/reset-password'
*/
sendResetPassword.post = (args: { company: number | { id: number } } | [company: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendResetPassword.url(args, options),
    method: 'post',
})
...
* @route '/admin/companies/{company}/reset-password'
*/
const sendResetPasswordForm = (args: { company: number | { id: number } } | [company: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/companies/{company}/reset-password'
*/
sendResetPasswordForm.post = (args: { company: number | { id: number } } | [company: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: sendResetPassword.url(args, options),
    method: 'post',
})
...
const CompanyController = { index, create, store, edit, update, destroy, approve, reject, sendResetPassword }
