...
/**
* @see \App\Http\Controllers\Admin\AdminController::sendResetPassword
* @see app/Http/Controllers/Admin/AdminController.php:173
* @route '/admin/admins/{admin}/reset-password'
*/
export const sendResetPassword = (args: { admin: number | { id: number } } | [admin: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/admins/{admin}/reset-password'
*/
sendResetPassword.url = (args: { admin: number | { id: number } } | [admin: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { admin: args }
    }
...
* @route '/admin/admins/{admin}/reset-password'
*/
sendResetPassword.post = (args: { admin: number | { id: number } } | [admin: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendResetPassword.url(args, options),
    method: 'post',
})
...
* @route '/admin/admins/{admin}/reset-password'
*/
const sendResetPasswordForm = (args: { admin: number | { id: number } } | [admin: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/admins/{admin}/reset-password'
*/
sendResetPasswordForm.post = (args: { admin: number | { id: number } } | [admin: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: sendResetPassword.url(args, options),
    method: 'post',
})
...
const AdminController = { index, store, update, sendResetPassword, destroy }
