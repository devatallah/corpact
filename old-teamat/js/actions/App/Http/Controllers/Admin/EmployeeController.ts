...
* @see app/Http/Controllers/Admin/EmployeeController.php:28
...
* @see app/Http/Controllers/Admin/EmployeeController.php:51
...
* @see app/Http/Controllers/Admin/EmployeeController.php:78
...
* @see app/Http/Controllers/Admin/EmployeeController.php:94
...
* @see app/Http/Controllers/Admin/EmployeeController.php:126
* @route '/admin/employees/{employee}'
*/
...
/**
* @see \App\Http\Controllers\Admin\EmployeeController::sendResetPassword
* @see app/Http/Controllers/Admin/EmployeeController.php:112
* @route '/admin/employees/{employee}/reset-password'
*/
export const sendResetPassword = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/employees/{employee}/reset-password'
*/
sendResetPassword.url = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { employee: args }
    }
...
* @route '/admin/employees/{employee}/reset-password'
*/
sendResetPassword.post = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendResetPassword.url(args, options),
    method: 'post',
})
...
* @route '/admin/employees/{employee}/reset-password'
*/
const sendResetPasswordForm = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/employees/{employee}/reset-password'
*/
sendResetPasswordForm.post = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: sendResetPassword.url(args, options),
    method: 'post',
})
...
const EmployeeController = { index, create, store, edit, update, destroy, sendResetPassword }
