...
/**
* @see \App\Http\Controllers\Auth\InvitationController::show
* @see app/Http/Controllers/Auth/InvitationController.php:39
* @route '/invite/{token}'
*/
...
/**
* @see \App\Http\Controllers\Auth\InvitationController::accept
* @see app/Http/Controllers/Auth/InvitationController.php:79
* @route '/invite/{token}'
*/
...
/**
* @see \App\Http\Controllers\Auth\InvitationController::verify
* @see app/Http/Controllers/Auth/InvitationController.php:119
* @route '/invite/{token}/verify'
*/
export const verify = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/invite/{token}/verify'
*/
verify.post = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: verify.url(args, options),
    method: 'post',
})
...
* @route '/invite/{token}/verify'
*/
const verifyForm = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/invite/{token}/verify'
*/
verifyForm.post = (args: { token: string | number } | [token: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: verify.url(args, options),
    method: 'post',
})
...
const InvitationController = { show, accept, verify }
