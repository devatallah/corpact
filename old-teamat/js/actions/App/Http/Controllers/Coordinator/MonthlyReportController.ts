...
/**
* @see \App\Http\Controllers\Coordinator\MonthlyReportController::storeRecommendations
* @see app/Http/Controllers/Coordinator/MonthlyReportController.php:148
* @route '/coordinator/reports/{report}/recommendations'
*/
export const storeRecommendations = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeRecommendations.url(args, options),
    method: 'post',
})

storeRecommendations.definition = {
    methods: ["post"],
...
* @route '/coordinator/reports/{report}/recommendations'
*/
storeRecommendations.url = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { report: args }
    }
    ...
    return storeRecommendations.definition.url
            .replace('{report}', parsedArgs.report.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/coordinator/reports/{report}/recommendations'
*/
storeRecommendations.post = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeRecommendations.url(args, options),
    method: 'post',
})
...
* @route '/coordinator/reports/{report}/recommendations'
*/
const storeRecommendationsForm = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: storeRecommendations.url(args, options),
    method: 'post',
})
...
* @route '/coordinator/reports/{report}/recommendations'
*/
storeRecommendationsForm.post = (args: { report: number | { id: number } } | [report: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: storeRecommendations.url(args, options),
    method: 'post',
})

storeRecommendations.form = storeRecommendationsForm
...
const MonthlyReportController = { index, show, storeRecommendations, exportMethod, export: exportMethod }
