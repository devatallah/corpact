...
/**
* @see \App\Http\Controllers\Company\EmployeeImportController::sendInvites
* @see app/Http/Controllers/Company/EmployeeImportController.php:112
* @route '/company/employees/import/{import}/invites'
*/
export const sendInvites = (args: { import: number | { id: number } } | [importParam: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendInvites.url(args, options),
    method: 'post',
})

sendInvites.definition = {
    methods: ["post"],
...
* @route '/company/employees/import/{import}/invites'
*/
sendInvites.url = (args: { import: number | { id: number } } | [importParam: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { import: args }
    }
    ...
    return sendInvites.definition.url
            .replace('{import}', parsedArgs.import.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/company/employees/import/{import}/invites'
*/
sendInvites.post = (args: { import: number | { id: number } } | [importParam: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sendInvites.url(args, options),
    method: 'post',
})
...
* @route '/company/employees/import/{import}/invites'
*/
const sendInvitesForm = (args: { import: number | { id: number } } | [importParam: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: sendInvites.url(args, options),
    method: 'post',
})
...
* @route '/company/employees/import/{import}/invites'
*/
sendInvitesForm.post = (args: { import: number | { id: number } } | [importParam: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: sendInvites.url(args, options),
    method: 'post',
})

sendInvites.form = sendInvitesForm

const EmployeeImportController = { index, store, errors, sendInvites }
