...
<div class="sc on" id="csettle">
  ...
  <div style="background:#1A5FAB18;border:1px solid #1A5FAB33;border-radius:14px;padding:14px 18px;display:flex;gap:12px;">
    ...
    <div><div style="font-size:13px;font-weight:700;color:#1A5FAB;margin-bottom:4px;">كيف تعمل التسويات؟</div><div style="font-size:12px;color:#4A3828;line-height:1.6;">بعد خصم عمولة المنصة ({{ $partner->commission_rate ?? 10 }}%)، يُحول الصافي لحسابك خلال 3 أيام عمل من تاريخ الفعالية.</div></div>
  </div>
</div>
