...
<div class="sidebar" id="sb">
  ...
  <nav>
    ...
    <div class="ni on" onclick="window.location='/partner/settlements'"><span>💰</span><span class="nl"> التسويات</span></div>
...
<div class="sc on">
  <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
    <a href="{{ route('partner.settlements.index') }}" style="color:#8A7868;text-decoration:none;font-size:14px;">← التسويات</a>
  ...
  <div style="background:#fff;border:1px solid #E2E8F4;border-radius:16px;padding:32px;max-width:600px;">
    ...
    <div style="margin-top:24px;">
      <a href="{{ route('partner.settlements.index') }}" style="display:block;text-align:center;padding:12px;background:#E2E8F4;border-radius:10px;color:#4A5C78;font-size:14px;font-weight:700;text-decoration:none;">العودة للتسويات</a>
    </div>
  </div>
</div>
</div>
