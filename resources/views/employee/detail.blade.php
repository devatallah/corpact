...
<div class="screen on" id="sDetail">
  <div style="padding:16px 0 20px;"><div style="font-size:11px;color:#7A8BA8;">تفاصيل الفعالية</div><div style="font-size:20px;font-weight:800;">{{ $event->partner->name }}</div><div style="font-size:13px;color:#7A8BA8;">{{ $event->partner->district }}</div></div>
