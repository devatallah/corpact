...
<title>كورباكت — دخول الموظف</title>
<style>
...
<div class="login-container">
    <div class="logo-section">
        ...
        <div class="logo-desc">بوابة الموظفين</div>
    </div>
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('employee.login') }}">
            ...
            <div class="field">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="employee@company.com" required autofocus dir="ltr">
            </div>
            ...
            <div class="field-row">
                ...
                <a href="{{ route('employee.password.request') }}" style="font-size:12px;color:#009E82;text-decoration:none;">نسيت كلمة المرور؟</a>
            </div>
        ...
        <div class="demo-section">
            ...
            <div class="demo-grid">
                <button type="button" class="demo-btn" onclick="fillDemo('emp1@advancedtech.sa')">
                    <div class="demo-role">موظف - تقنية متقدمة</div>
                    <div class="demo-email">emp1@advancedtech.sa</div>
                </button>
                <button type="button" class="demo-btn" onclick="fillDemo('emp1@innovation.sa')">
                    <div class="demo-role">موظف - ابتكار</div>
                    <div class="demo-email">emp1@innovation.sa</div>
                </button>
            </div>
        </div>
    </div>
