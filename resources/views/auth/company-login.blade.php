...
<title>كورباكت — دخول الشركة</title>
<style>
...
<div class="login-container">
    ...
    <div class="card">
        ...
        <div class="card-sub">أدخل بياناتك للوصول إلى لوحة الشركة</div>
        ...
        <form method="POST" action="{{ route('company.login') }}">
            ...
            <div class="field">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="hr@company.com" required autofocus dir="ltr">
            </div>
            ...
            <div class="field-row">
                ...
                <a href="{{ route('company.password.request') }}" style="font-size:12px;color:#009E82;text-decoration:none;">نسيت كلمة المرور؟</a>
            </div>
        ...
        <div class="login-link" style="text-align:center;margin-top:20px;">
            <a href="{{ route('company.register') }}" style="font-size:13px;color:#009E82;text-decoration:none;">ليس لديك حساب؟ سجل الآن</a>
        </div>

        <div class="demo-section">
            <div class="demo-title">حسابات تجريبية</div>
            <div class="demo-grid">
                <button type="button" class="demo-btn" onclick="fillDemo('hr@advancedtech.sa')">
                    <div class="demo-role">تقنية متقدمة</div>
                    <div class="demo-email">hr@advancedtech.sa</div>
                </button>
                <button type="button" class="demo-btn" onclick="fillDemo('hr@innovation.sa')">
                    <div class="demo-role">ابتكار</div>
                    <div class="demo-email">hr@innovation.sa</div>
                </button>
            </div>
        </div>
    </div>
