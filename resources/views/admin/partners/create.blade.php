...
<div class="sc on">
  <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
    ...
    <span style="color:#fff;font-weight:700;">إضافة شريك</span>
  </div>
  ...
  <div class="card" style="max-width:600px;">
    <div style="font-size:18px;font-weight:700;margin-bottom:20px;">إضافة شريك جديد</div>
    <form method="POST" action="{{ route('admin.partners.store') }}">
      ...
      <div style="margin-bottom:16px;">
        ...
        <input type="text" name="name" value="{{ old('name') }}" required style="width:100%;padding:10px 14px;background:#0F1117;border:1px solid #232A3E;border-radius:10px;color:#E8EAF0;font-size:14px;font-family:inherit;outline:none;" placeholder="مثال: شريك الرياض">
      </div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:16px;">
        <div>
          ...
          <input type="email" name="email" value="{{ old('email') }}" required dir="ltr" style="width:100%;padding:10px 14px;background:#0F1117;border:1px solid #232A3E;border-radius:10px;color:#E8EAF0;font-size:14px;font-family:inherit;outline:none;" placeholder="info@partner.com">
        </div>
        <div>
