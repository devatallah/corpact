...
<title>تيمات — إضافة فعالية</title>
  ...
  <div class="card" style="max-width:600px;">
    ...
    <form method="POST" action="{{ route('admin.events.store') }}">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:16px;">
        <div>
          <label style="display:block;font-size:12px;font-weight:600;color:rgba(255,255,255,.6);margin-bottom:6px;">معرّف الشريك *</label>
          <input type="number" name="partner_id" value="{{ old('partner_id') }}" required min="1" style="width:100%;padding:10px 14px;background:#0F1117;border:1px solid #232A3E;border-radius:10px;color:#E8EAF0;font-size:14px;font-family:inherit;outline:none;">
        </div>
        <div>
