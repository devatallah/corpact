...
export default function Welcome() {
    ...
    const [activePortal, setActivePortal] = useState<'employee' | 'hr' | 'partner'>('employee');
    ...
    const portalTabs: { key: 'employee' | 'hr' | 'partner'; num: string; label: string }[] = [
        { key: 'employee', num: '01', label: 'الموظف' },
        { key: 'hr', num: '02', label: 'الشركة' },
        { key: 'partner', num: '03', label: 'الشريك' },
    ];
    ...
    const faqData = [
        ...
        { q: 'ما هي مرافق الشركاء والرياضات المتاحة؟', a: 'أكثر من 240 ناديًا شريكًا في 20 مدينة، تغطّي البادل، التنس، كرة القدم، السلة، الكروسفت، السباحة، والركوب. الشبكة تتوسّع بشكل أسبوعي. يمكن لشركتك أيضاً ضمّ ناديها المفضّل إلى الشبكة عبر فريق الشراكات.' },
                ...
                <div className="wrap hero-grid">
                    <div>
                        ...
                        <p className="hero-sub">
                            تيمات هي المنصّة المؤسسية الأولى التي تربط شركتك بأفضل الشركاء الرياضية في المملكة. حجوزات جماعية، فعاليات للموظفين، ومجتمع رياضي حقيقي يعيش داخل بيئة العمل — بلوحة تحكّم واحدة لإدارة الموارد البشرية.
                        </p>
                ...
                <div className="wrap">
                    ...
                    <div className="benefits-grid reveal-stagger">
                        <div className="benefit big">
                            ...
                            <p className="benefit-p">انطلق بدون فريق بناء داخلي. تيمات تأتي جاهزة بالشركاء، الموظفين، الأنظمة، والتقارير — لتقدّم أثراً ملموساً من اليوم الأول.</p>
            ...
            <section className="portals section-pad" id="portals">
                <div className="wrap">
                    <div className="section-head reveal">
                        ...
                        <p className="section-sub">من الموظف الذي يبحث عن مباراة بعد العمل، إلى مدير الموارد البشرية الذي يقيس الأثر، إلى الشريك الذي يدير ملاعبه — كلٌ بأدواته.</p>
                    </div>
                    ...
                    <div className={`portal-panel${activePortal === 'employee' ? ' active' : ''}`}>
                        ...
                        <JourneySlider total={6}>
                            ...
                            <div className="journey-step alt" dangerouslySetInnerHTML={{ __html: `<div class="journey-content"><div class="journey-num"><span class="journey-num-n">02</span><span class="journey-num-l">/ DAY 1 · 30 SECONDS LATER</span></div><h3 class="journey-h">تسجيل في 30 ثانية، مع تحقّق فوري.</h3><p class="journey-p">الموظف ينقر الرابط، يدخل اسمه وكلمة المرور، ويبدأ. النظام يتحقق تلقائياً من بريد الشركة ويربطه بحساب الشريك دون تدخل HR.</p><ul class="journey-feat"><li>تسجيل دخول بـ Apple أو Google متاح</li><li>التزام بـ PDPL ومتطلبات SDAIA</li><li>تكامل SSO للمؤسسات الكبرى</li></ul></div><div class="journey-mock"><div class="journey-visual"><span class="journey-visual-num">02</span><span class="journey-visual-icon">🔐</span></div></div>` }} />
                            ...
                            <div className="journey-step" dangerouslySetInnerHTML={{ __html: `<div class="journey-content"><div class="journey-num"><span class="journey-num-n">05</span><span class="journey-num-l">/ DAY 1 · 7:00 PM</span></div><h3 class="journey-h">يوم المباراة. كل شيء جاهز.</h3><p class="journey-p">قبل المباراة بـ 30 دقيقة، يصل تذكير. يفتح الموظف التطبيق فيجد العنوان، الزملاء المؤكَّدين، الخريطة، ورمز QR لتسجيل الوصول عند بوابة الشريك.</p><ul class="journey-feat"><li>تذكيرات ذكية قبل 24 ساعة و30 دقيقة</li><li>تسجيل وصول QR للشركاء الشريكين</li><li>تنبيه عند تأخر أحد اللاعبين</li></ul></div><div class="journey-mock"><div class="journey-visual"><span class="journey-visual-num">05</span><span class="journey-visual-icon">🏟️</span></div></div>` }} />
                    ...
                    {/* PARTNER PANEL */}
                    <div className={`portal-panel${activePortal === 'partner' ? ' active' : ''}`}>
                        <div className="section-head reveal">
                            <div className="eyebrow">رحلة الشريك الشريك</div>
                            <h2 className="section-title">من التسجيل <span className="serif-en">to monthly settlement</span>.</h2>
                            <p className="section-sub">شاهد كيف يدير الشركاء ملاعبهم وحجوزاتهم وإيراداتهم عبر تيمات — من لحظة الانضمام إلى التسوية الشهرية.</p>
                        </div>
                        <JourneySlider total={6}>
                            <div className="journey-step" dangerouslySetInnerHTML={{ __html: `<div class="journey-content"><div class="journey-num"><span class="journey-num-n">01</span><span class="journey-num-l">/ APPLY · 24h VERIFICATION</span></div><h3 class="journey-h">انضم لشبكة الشركات في 48 ساعة.</h3><p class="journey-p">يقدّم الشريك طلب الانضمام عبر استمارة بسيطة: الموقع، الرياضات، عدد الملاعب، وصور. فريق تيمات يتحقّق ويفعّل الشريك خلال يوم عمل واحد — لا عقود طويلة، لا رسوم انضمام.</p><ul class="journey-feat"><li>تسجيل مجاني، بدون عقود طويلة الأمد</li><li>تحقّق سريع خلال 24 ساعة</li><li>دعم متخصص بالعربية من فريق الشراكات</li></ul></div><div class="journey-mock"><div class="journey-visual"><span class="journey-visual-num">01</span><span class="journey-visual-icon">📋</span></div></div>` }} />
                            <div className="journey-step alt" dangerouslySetInnerHTML={{ __html: `<div class="journey-content"><div class="journey-num"><span class="journey-num-n">02</span><span class="journey-num-l">/ COURT SETUP · YOUR PRICES</span></div><h3 class="journey-h">أسعار مرنة لكل ملعب ولكل مدة.</h3><p class="journey-p">يضع الشريك أسعاره الخاصة لكل ملعب، حسب المدة (60، 90، 120 دقيقة). لا قيود من تيمات على التسعير — الشريك يحتفظ بسلطته الكاملة على أسعاره.</p><ul class="journey-feat"><li>تسعير ديناميكي حسب اليوم والوقت</li><li>أسعار مختلفة للشركات والأفراد</li><li>عروض موسمية قابلة للجدولة</li></ul></div><div class="journey-mock"><div class="journey-visual"><span class="journey-visual-num">02</span><span class="journey-visual-icon">🏷️</span></div></div>` }} />
                            <div className="journey-step" dangerouslySetInnerHTML={{ __html: `<div class="journey-content"><div class="journey-num"><span class="journey-num-n">03</span><span class="journey-num-l">/ INCOMING REQUESTS · CORPORATE</span></div><h3 class="journey-h">حجوزات الشركات تصل تلقائياً.</h3><p class="journey-p">بمجرّد التفعيل، يبدأ الشريك باستقبال طلبات حجز من شركات تيمات. كل طلب يأتي مع تفاصيل الفريق، الوقت، والمبلغ. قبول أو رفض بنقرة — أو تفعيل القبول التلقائي للشركات الموثوقة.</p><ul class="journey-feat"><li>طلبات مفصّلة مع عدد اللاعبين والوقت</li><li>قبول تلقائي للشركات الموثوقة</li><li>إشعارات فورية على الجوال</li></ul></div><div class="journey-mock"><div class="journey-visual"><span class="journey-visual-num">03</span><span class="journey-visual-icon">📬</span></div></div>` }} />
                ...
                <div className="wrap">
                    ...
                    <div className="wwh-grid reveal-stagger">
                        ...
                        <div className="wwh-card">
                            <div className="wwh-icon">💰</div>
                            <h3>تسويات شفافة</h3>
                            <p>تسويات شهرية تلقائية للشركاء. تقارير مفصّلة بكل حجز وعمولة ومبلغ صافي.</p>
                            <span className="wwh-tag biz">الشريك</span>
                        </div>
                        <div className="wwh-card">
                            <div className="wwh-icon">🏟️</div>
                            <h3>إدارة المرافق</h3>
            ...
            <section className="pricing section-pad" id="pricing">
                <div className="wrap">
                    <div className="section-head reveal">
                        ...
                        <p className="section-sub">رسوم اشتراك شهرية واضحة للشركاء والشركات. اختر الباقة المناسبة وابدأ اليوم.</p>
                    </div>
                    ...
                    <div className="pricing-grid reveal-stagger">
                        ...
                        <div className="pricing-card">
                            ...
                            <p className="pricing-desc">للشركاء الرياضية الصغار الذين يريدون الانضمام لشبكة الشركات.</p>
                            ...
                            <Link href="/partners#register" className="pricing-cta">ابدأ مجاناً لمدة 14 يوم</Link>
                        </div>
                        ...
                        <div className="pricing-card featured">
                            ...
                            <p className="pricing-desc">للشركات والشركاء الذين يريدون تجربة متكاملة وأقصى استفادة.</p>
                            <div className="pricing-amount">
                            ...
                            <Link href="/partners#register" className="pricing-cta">ابدأ تجربتك المجانية</Link>
                        </div>
                    ...
                    <div className="cta-card reveal">
                        <div className="cta-content">
                            ...
                            <div className="cta-actions">
                                ...
                                <Link href="/partners#register" className="btn btn-ghost" style={{ background: 'var(--ink)', color: 'var(--cream)', borderColor: 'var(--ink)' }}>سجّل كشريك</Link>
                            </div>
                        </div>
                    </div>
                </div>
