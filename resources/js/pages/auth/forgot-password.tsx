        ...
        <>
            ...
            <style>{`
                *{margin:0;padding:0;box-sizing:border-box;}
                ...
                .fp-wrap{min-height:100vh;background:linear-gradient(135deg,#0A0F1E,#1A2035);display:flex;align-items:center;justify-content:center;padding:20px;}
                .fp-inp{width:100%;padding:12px 14px;border:1px solid #E4E9F2;border-radius:12px;font-size:14px;color:#0F1923;background:#F4F6FA;outline:none;direction:ltr;font-family:inherit;transition:border-color .15s;}
                .fp-inp:focus{border-color:${cfg.focusColor};background:#fff;}
                .fp-submit:hover{transform:translateY(-1px);}
            `}</style>

            <div className="fp-wrap" dir="rtl">
                <div style={{ width: '100%', maxWidth: 400 }}>
                    ...
                    <div style={{ background: '#fff', borderRadius: 24, padding: '36px 32px', boxShadow: '0 24px 80px rgba(0,0,0,.4)' }}>
                        <div style={{ fontSize: 16, fontWeight: 800, textAlign: 'center', marginBottom: 4 }}>نسيت كلمة المرور</div>
                        ...
                        {(flash as Record<string, unknown>)?.status && (
                            <div style={{ background: '#009E8218', border: '1px solid #009E8233', borderRadius: 10, padding: '10px 14px', fontSize: 13, color: '#009E82', fontWeight: 600, marginBottom: 14 }}>
                                {(flash as Record<string, unknown>).status as string}
                            </div>
                        )}
