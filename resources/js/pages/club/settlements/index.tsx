...
import type { Club, Settlement, PaginatedResult } from '@/types/models';
...
export default function SettlementsIndex({ club, settlements, totals, filters }: Props) {
                            ...
                            {settlements.data.length === 0 ? (
                                ...
                                settlements.data.map((settlement) => (
                                    <tr
                                        ...
                                        onClick={() =>
                                            (window.location.href = `/club/settlements/${settlement.id}`)
                                        }
                                    >
                                        <td>
            ...
            <div style={{ background: '#1A5FAB18', border: '1px solid #1A5FAB33', borderRadius: 14, padding: '14px 18px', display: 'flex', gap: 12 }}>
                ...
                <div>
                    ...
                    <div style={{ fontSize: 12, color: '#4A3828', lineHeight: 1.6 }}>
                        بعد خصم عمولة المنصة ({club.commission_rate ?? 10}%)، يُحول الصافي
