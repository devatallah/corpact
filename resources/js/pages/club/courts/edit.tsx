...
export default function CourtEdit({ court, sports }: Props) {
    const form = useForm({
        name: court.name,
    ...
    return (
        <ClubLayout>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                ...
                <span style={{ fontWeight: 700 }}>تعديل: {court.name}</span>
            </div>
            ...
            <div style={{ background: '#fff', border: '1px solid #E2E8F4', borderRadius: 16, padding: 32, maxWidth: 500 }}>
                <div style={{ fontSize: 18, fontWeight: 700, marginBottom: 6 }}>تعديل الملعب</div>
                <div style={{ fontSize: 13, color: '#8A7868', marginBottom: 20 }}>{court.sport?.name ?? '-'}</div>
