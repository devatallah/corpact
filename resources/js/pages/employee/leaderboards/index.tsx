...
export default function EmployeeLeaderboards({
    ...
    return (
        <EmployeeLayout>
            ...
            <Note tone="info" title="تسجيل حضور ذكي وتلقائي">
                لا حاجة لمسح رمز QR ولا إثبات يدوي. عند انتهاء وقت الفعالية، تُحتسب نقطة المواظبة لكل مشارك مؤكد تلقائياً — ومن
                سُجِّل غائباً لا تُحتسب له.
            </Note>
            ...
            <Note title="حوكمة المواسم والأرشفة">
