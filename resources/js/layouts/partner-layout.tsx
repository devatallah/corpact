...
export default function PartnerLayout({ children }: { children: React.ReactNode }) {
    ...
    const allNavItems: (NavItem & { permission?: string })[] = [
        ...
        { label: '\u0637\u0644\u0628\u0627\u062A \u0627\u0644\u062D\u062C\u0632', href: '/partner/requests', emoji: '\uD83D\uDCCB', badge: pendingCount, permission: 'bookings.view' },
        ...
        { label: '\u0627\u0644\u062E\u0635\u0648\u0645\u0627\u062A', href: '/partner/discounts', emoji: '\uD83C\uDFF7\uFE0F', permission: 'discounts.view' },
