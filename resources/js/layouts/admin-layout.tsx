...
const allNavItems: (NavItem & { permission?: string })[] = [
    ...
    {
        label: 'إشراف المزوّدين',
        href: '/admin/providers/oversight',
        icon: Compass,
        permission: 'platform.manage',
    },
    {
    ...
    {
        label: 'مراقبة الفعاليات الشبح',
        href: '/admin/monitoring/ghost-events',
        icon: Ghost,
        permission: 'platform.manage',
    },
    {
        label: 'تقارير المنسّق المُدار',
    ...
    },
    {
        ...
        href: '/admin/finance/topups',
        icon: Landmark,
        permission: 'wallet.topup.approve',
    },
    {
        label: 'فشل المدفوعات',
        href: '/admin/payments/failures',
        icon: AlertTriangle,
        permission: 'payments.failures.view',
    },
    {
        label: 'التسويات',
    ...
    {
        label: 'شروط العقود',
        href: '/admin/finance/terms',
        icon: Ruler,
        permission: 'invoice.approve',
    },
    {
        label: 'الصفة الضريبية',
        href: '/admin/finance/tax-status',
        icon: FileSpreadsheet,
        permission: 'invoice.approve',
    },

    /*
     * الدعم (G/«دليل وكيل الدعم») + سجل التدقيق (H §16 + §19).
     *
     * الترتيب والتسميات كما في الدليل: خمس مهام متمايزة لا شاشة جامعة. كانت
     * ثلاث منها مطويّة داخل «مركز الدعم» فلا يجدها الوكيل إلا بالمرور بشاشة
     * بحث لا تعنيه.
     */
    {
        ...
        icon: Search,
        permission: 'support.search',
    },
    {
        label: 'سجل الفعاليات والحالات',
        href: '/admin/support/events',
        icon: CalendarClock,
        permission: 'event.history.view',
    },
    {
        label: 'سجل الإشعارات والتسليم',
        href: '/admin/notification-logs',
        icon: Bell,
        permission: 'notifications.logs.view',
    },
    {
        label: 'إعادة إرسال الدعوات',
        href: '/admin/support/resend',
        icon: SendHorizontal,
        permission: 'support.resend',
    },
    {
        label: 'توثيق البلاغات والتصعيد',
        href: '/admin/support',
        icon: Headphones,
        permission: 'support.messages.manage',
    },
    {
        label: 'سجل التدقيق',
        href: '/admin/audit',
    ...
    },
    {
        ...
        href: '/admin/security/permission-review',
        icon: SearchCheck,
